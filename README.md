...
## Installation
_Disclaimer: You probably shouldn't. These config files contain lots of settings that might only work on my machine. They will replace the config files that are already on your computer, so things will probably break.
